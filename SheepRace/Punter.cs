...
namespace SheepRace
{
    ...
    public class Love : Punter // Inherit from the Punter class
    {
        public Love() // Sets up the punter Love
        {
            Name = "Love";
            Cash = 50;
        }
    ...
    public class Dilpreet : Punter // Inherit from the Punter class
    {
        public Dilpreet() // Sets up the punter Dilpreet
        {
            Name = "Dilpreet";
            Cash = 50;
        }
